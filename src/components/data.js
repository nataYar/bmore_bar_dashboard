...
export const CongelatoDaiquiriMenu = {
    category: 'drinks', 
    name: 'Congelato Daiquiri Menù',
    price:'12.75',
    items: [
        {
            name: 'ABV 20% Spirits Soju Vodka, Rum &/Or Tequila.',
            description: 'A Classic Frozen Refreshment filled with Flavors of the Tropics'
            },
            {
            name: 'Mango-Piña Colada-Raspberry-Strawberry-Peach-Mojito-Margarita'
            }
    ]
}

export const Lattini = {
    name: 'Lattini (Coffee Drinks)',
    category: 'drinks', 
    price: '11.95',
    note: 'note',
    items: [
...
export const ClassicCocktails = {
    ...
    items: [
        {
        name: 'Cosmo, Margarita, Cuba Libre, Long Island Iced Tea, Bloody Mary',
...
export const Awaken = {
    ...
    items: [
        {
            name: '#Iced Açai or Pitaya Lavender Latte',
...
export const OJDetoxImmuneBooster = {
    ...
    items:[
        ...
        name: 'Organic Reds + Probiotics',
        },{
        name: 'Organic Greens + Probiotics',
        }
    ],
...
export const Pizza = {
    category: 'food', 
    name:'Pizza (Personale)',
    price:'24.95-28.65',
    items: [
        {name: 'Formaggio Tradizionale (Cheese)',
        ...
        {name: 'Prosciutto di Parma e Crema di Formaggio',
        ...
        {name: 'Pistachio Mortadella e Gorgonzola',
